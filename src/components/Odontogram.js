...
export default function Odontogram() {
  const {odontogramData} = useOdontogram();
      ...
      <div className="flex gap-6">
        <div>
          ...
          <div className="flex flex-wrap gap-2 mb-2">
            <ButtonOdontogram num={0}>
              <ButtonColor />
            </ButtonOdontogram>
            <ButtonOdontogram num={1}>
              <OdontogramComplete />
            </ButtonOdontogram>
            <ButtonOdontogram num={2}>
              <Absent />
            </ButtonOdontogram>
            <ButtonOdontogram num={3}>
              <Crown />
            </ButtonOdontogram>
            <ButtonOdontogram num={4}>
              <FilteredOut />
            </ButtonOdontogram>
            <ButtonOdontogram num={5}>
              <Fractured />
            </ButtonOdontogram>
          </div>
        </div>
        <div>
          ...
          <div className="flex flex-wrap gap-2 mb-2">
            <ButtonOdontogram num={6}>
              <ButtonColor color="red" />
            </ButtonOdontogram>
            <ButtonOdontogram num={7}>
              <OdontogramComplete color="red" />
            </ButtonOdontogram>
            <ButtonOdontogram num={8}>
              <Absent color="red" />
            </ButtonOdontogram>
            <ButtonOdontogram num={9}>
              <Crown color="red" />
            </ButtonOdontogram>
          </div>
        </div>
