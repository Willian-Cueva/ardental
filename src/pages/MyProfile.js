...
export default function MyProfile() {
  ...
  const updatePass =async () =>{
    setready(false);
    const d =document;
    const email = session.email,howPass = d.getElementById("id-inp-howPassword-up").value,newPass = d.getElementById("id-inp-password-up").value,repPass = d.getElementById("id-inp-repeatPassword-up").value
  ...
  useEffect(() => {
    getUser(session.email).then((res) => {
      const d = document;
  ...
  return (
    <Main title="Mi Perfil">
      ...
      <Modal show={showChangePass}>
        ...
        <InputPassLogin text="Contraseña Actual" id={"id-inp-howPassword-up"} />
        <InputPassLogin text="Establesca la nueva contraseña" id={"id-inp-password-up"} />
        <InputPassLogin
